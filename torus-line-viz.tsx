  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <h3 style={{ margin: '0 0 15px 0', fontSize: '22px', fontWeight: '600' }}>
        ...
        <div style={{ marginBottom: '18px' }}>
          <label style={{ display: 'block', marginBottom: '8px', fontSize: '14px', color: '#ccc' }}>
            Slope: <span style={{ color: '#ff5252', fontWeight: '600' }}>{slope.toFixed(6)}</span>
          </label>
          <input
            type="range"
            min="1"
        ...
        <div style={{ marginBottom: '18px' }}>
          <label style={{ display: 'block', marginBottom: '8px', fontSize: '14px', color: '#ccc' }}>
            Speed: <span style={{ color: '#ffeb3b', fontWeight: '600' }}>{speed}x</span>
          </label>
          <input
            type="range"
            min="0.5"
        ...
        <div style={{ marginBottom: '18px' }}>
          <label style={{ display: 'block', marginBottom: '8px', fontSize: '14px', color: '#ccc' }}>
            Max Wraps: <span style={{ color: '#2196f3', fontWeight: '600' }}>{maxWraps}</span>
          </label>
          <input
            type="range"
            min="20"
        ...
        <div style={{ marginBottom: '10px' }}>
          <div style={{ fontSize: '13px', marginBottom: '8px', color: '#ccc' }}>Irrational slopes:</div>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
            {presetSlopes.map((preset) => (
              <button
                ...
                style={{
                  padding: '6px 12px',
                  background: Math.abs(slope - preset.value) < 0.001 ? '#ff5252' : '#333',
                  color: 'white',
        ...
        <div style={{ fontSize: '11px', color: '#999', marginTop: '15px', lineHeight: '1.5' }}>
          <p style={{ margin: '5px 0' }}>
            The <span style={{ color: '#ff5252' }}>red line</span> wraps around the torus with irrational slope, never closing and densely filling the surface.
          </p>
          <p style={{ margin: '5px 0' }}>
            <span style={{ color: '#ffeb3b' }}>Yellow dot</span> shows current position.
          </p>
        </div>
      </div>
    </div>
